...
shows_cleaned |>
  ...
  ungroup() |> 
  group_by(series) |> 
  # can't tell the lift from a new season occuring in the first report because we don't have that information
...
multi_report_shows |> 
  ...
  ungroup() |> 
  group_by(report_date) |> 
  summarise(median_dropoff = mean(dropoff)) |> 
  gt() |> 
  format_table_header() |> 
  format_table_style() |> 
  format_table_numbers(scale_vals = TRUE) |> 
