...
boot_dist |> 
  ...
  visualize() +
  shade_p_value(obs_stat = exp(sample_median)-1, direction = 'one_sided') +
  shade_confidence_interval(ci, alpha = .25)+
  my_plot_theme()
